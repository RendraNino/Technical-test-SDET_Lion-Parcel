...
class TestAsperformanceglitchuser():
  ...
  def test_asperformanceglitchuser(self):
    # Test name: As performance_glitch_user
    ...
    # 5 | type | css=*[data-test="username"] | performance_glitch_user
